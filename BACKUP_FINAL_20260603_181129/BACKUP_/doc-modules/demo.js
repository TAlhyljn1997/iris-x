  ...
  <main class="doc-content">
    ...
    <section id="screen1" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/Screen1.jpeg" alt="Order Book Dump" loading="lazy" />
    ...
    <section id="screen2" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/Screen2.jpeg" alt="Historical Chart" loading="lazy" />
    ...
    <section id="screen3" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/Screen3.jpeg" alt="Tape Engine Analysis" loading="lazy" />
    ...
    <section id="screen4" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/Screen4.jpeg" alt="Flow Engine Analysis" loading="lazy" />
    ...
    <section id="screen5" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/Screen5.jpeg" alt="Microstructure Engine" loading="lazy" />
    ...
    <section id="screen6" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/Screen6.jpeg" alt="Balance Laws Computation" loading="lazy" />
    ...
    <section id="screen7" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/Screen7.jpeg" alt="Modules Overview" loading="lazy" />
    ...
    <section id="screen8" class="doc-section screen-section">
      ...
      <figure class="screen-image">
        <img src="../images/linkedinpost2.jpg" alt="CIE-X Report" loading="lazy" />
